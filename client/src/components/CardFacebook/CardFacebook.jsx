    ...
    <>
     {
      ...
      <div className=" bg-gray-100 flex items-center justify-center mt-2 lg:w-full">
        <div className="w-80 bg-white rounded-lg mb-2  shadow-lg hover:shadow-2xl transition duration-500 transform cursor-pointer">
          <div className="flex items-center mb-2 space-x-4">
            <img className="w-10 rounded-full ml-2 transition duration-500 transform hover:scale-105" src="https://www.adobe.com/express/create/media_1bcd514348a568faed99e65f5249895e38b06c947.jpeg?width=2000&format=webply&optimize=medium" alt="David" />
          <div>
            ...
            <p className='text-justify text-xs py-2'>{item.desc}</p>
