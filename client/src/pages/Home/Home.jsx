    ...
    <div >
      <div>
        ...
        <div className='bodyContainer bg-gray-300'>
          <div className='xl:h-52 sm:h-28 flex flex-col items-center py-6'>
          ...
          <div className='componentscrooll xl:flex mdd:flex md:flex-col lg:flex-col xl:flex-row xl:max-w-5xl mdd:max-w-2xl mx-auto lg:max-w-5xl md:max-w-sm sm:max-w-full  gap-1 shadow-2xl sm:h-96 lg:h-96 md:h-96  '>
