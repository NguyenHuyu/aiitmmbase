...
import building from './building.jfif'
  ...
  return (
    <div className='pt-[10px] px-[3%] md:px-[6%] xl:px-[10%]'>
      ...
      <div className='flex flex-col lg:flex-row lg:gap-[20px] xl:justify-center'>
        <img src={building} className='mx-[auto] mt-[10px] w-full h-[180px] object-cover md:w-[50%] md:mt-[20px] lg:h-[auto] lg:flex-[3] xl:max-w-[500px] xl:mx-[0]'/>
